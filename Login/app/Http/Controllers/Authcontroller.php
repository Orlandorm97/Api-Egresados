...
class Authcontroller extends Controller
{
    public function index(Request $data){
        $data = Egresado::select('ap_paterno','ap_materno','nombres', 'genero', 'fecha_nacimiento', 'telefono','Provincia','Distrito')->where('matricula', Auth::user()->egresado_matricula)->get();
        return $data;
    }
